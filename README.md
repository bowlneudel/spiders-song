...
- The story behind this project is a 2-part podcast from Future Ecologies and featuring [Dr. Wayne Maddison](https://waynemaddisonlab.wordpress.com/wayne-maddison/), available [here](https://www.futureecologies.net/listen/fe-5-1-spiders-song)
...
- Lineage duration is not ultraparametric without careful settings see: [Time/playback](https://github.com/bowlneudel/spiders-song/blob/main/README.md#time--playback))
