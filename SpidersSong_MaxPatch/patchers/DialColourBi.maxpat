...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 50.0, 290.0, 55.0, 23.0 ],
					"text" : "+ 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 125.0, 240.0, 55.0, 23.0 ],
					"text" : "* 0.75"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 62.331319808959961, 254.0, 42.5, 23.0 ],
					"text" : "* 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 124.884522378444672, 304.0, 54.5, 23.0 ],
					"text" : "- 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 124.884522378444672, 277.931608438491821, 48.0, 23.0 ],
					"text" : "!/ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.66827654838562, 323.79633550795802, 72.826086521148682, 23.0 ],
					"text" : "1. $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 35.247017741203308, 203.931608438491821, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 124.0, 331.79633550795802, 72.826086521148682, 23.0 ],
					"text" : "$1 $1 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 104.884522378444672, 195.931608438491821, 39.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 73.16827654838562, 162.408809472649182, 55.0, 23.0 ],
					"text" : ">= 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 169.469448685646057, 388.481413672398958, 117.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.66827654838562, 388.481413672398958, 118.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 50.0, 100.0, 274.832117140293121, 23.0 ],
					"text" : "unpack s f"
				}
